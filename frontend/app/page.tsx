      ...
      <section className="flex-1 p-10 overflow-y-auto">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-zinc-400 mb-10 text-lg">
            ...
            AI-powered creator analysis for storytelling,
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                ...
                <ScoreCard
                  ...
                  score={analysis.retention_score}
                />
                ...
                <ScoreCard
                  title="Storytelling"
                  score={analysis.storytelling_score}
                />
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (
                    ...
                    toast.error(
                      "Please enter valid YouTube URLs for both videos"
                    );
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
                      ...
                      <div className="space-y-2 text-zinc-300 text-sm">
                        ...
                        <MetaRow
                          label="Creator"
                          value={
                            compareData.video_a_metadata?.creator ||
                            "Unknown"
                          }
                        />
                        ...
                        <MetaRow
                          label="Views"
                          value={
                            compareData.video_a_metadata?.views?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Likes"
                          value={
                            compareData.video_a_metadata?.likes?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Comments"
                          value={
                            compareData.video_a_metadata?.comments?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Followers"
                          value={
                            compareData.video_a_metadata?.followers?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Duration"
                          value={`${compareData.video_a_metadata?.duration || 0}s`}
                        />

                        <MetaRow
                          label="Upload Date"
                          value={
                            compareData.video_a_metadata?.upload_date ||
                            "N/A"
                          }
                        />
                        ...
                        <MetaRow
                          ...
                          value={`${compareData.video_a_metadata?.engagement_rate || 0}%`}
                        />

                        <MetaRow
                          label="Chunks Retrieved"
                          value={
                            compareData.video_1_sources?.length || 0
                          }
                        />
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
                      ...
                      <div className="space-y-2 text-zinc-300 text-sm">
                        ...
                        <MetaRow
                          label="Creator"
                          value={
                            compareData.video_b_metadata?.creator ||
                            "Unknown"
                          }
                        />
                        ...
                        <MetaRow
                          label="Views"
                          value={
                            compareData.video_b_metadata?.views?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Likes"
                          value={
                            compareData.video_b_metadata?.likes?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Comments"
                          value={
                            compareData.video_b_metadata?.comments?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Followers"
                          value={
                            compareData.video_b_metadata?.followers?.toLocaleString() ||
                            "0"
                          }
                        />
                        ...
                        <MetaRow
                          label="Duration"
                          value={`${compareData.video_b_metadata?.duration || 0}s`}
                        />

                        <MetaRow
                          label="Upload Date"
                          value={
                            compareData.video_b_metadata?.upload_date ||
                            "N/A"
                          }
                        />
                        ...
                        <MetaRow
                          label="Engagement Rate"
                          value={`${compareData.video_b_metadata?.engagement_rate || 0}%`}
                        />

                        <MetaRow
                          label="Chunks Retrieved"
                          value={
                            compareData.video_2_sources?.length || 0
                          }
                        />
